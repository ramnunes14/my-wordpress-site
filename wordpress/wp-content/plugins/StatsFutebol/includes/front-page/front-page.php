...
<div class="form-container">
        ...
        <div class="tipos">
            <form action="#" method="POST">
                <input type="hidden"  name="name" value='ola'>
                <input type="hidden"    name="jogador"  value="goals" required>
                <button type="submit" class="botao-post">Goals</button>
            </form>
            <form action="#" method="POST">
                <input type="hidden"  name="name" value='ola'>
                <input type="hidden"    name="jogador"  value="assists" required>
                <button type="submit" class="botao-post">Assistencias</button>
            </form>
            <form action="#" method="POST">
                <input type="hidden"  name="name" value='ola'>
                <input type="hidden"    name="jogador"  value="cards" required>
                <button type="submit" class="botao-post">Cartões</button>
            </form>
            <form action="#" method="POST">
                <input type="hidden"  name="name" value='ola'>
                <input type="hidden"    name="jogador"  value="minutes" required>
                <button type="submit" class="botao-post">Minutos</button>
            </form>
            <form action="#" method="POST">
                <input type="hidden"  name="name" value='ola'>
                <input type="hidden"    name="jogador"  value="all" required>
                <button type="submit" class="botao-post">Nomes</button>
            </form>
            <form action="#" method="POST">
                <input type="hidden"  name="name" value='ola'>
                <input type="hidden"    name="jogador"  value="rank" required>
